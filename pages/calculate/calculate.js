...
Page({
  ...
  textDesc2: function (weight,referWeight,BMIDesc) {
    if (BMIDesc == '偏瘦') {
      return '根据您当前的身高体重计算，体重至少保持在' + (referWeight*0.9).toFixed(1) + '以上为正常状态，身体状况为偏瘦，当低于标准时，容易对身体带来危害，如脱发、骨质疏松，贫血，记忆衰退、常犯胃病等。造成瘦弱的原因普遍为先天精气不足，脾胃虚弱，脾肾阳虚，肝肾阴虚。建议应前往医院查找具体原因，除此之外，在生活和饮食习惯中应保持良好的心态，乐观积极，多做一些运动缓解压力，在饮食方面尽量多摄入肉类（牛肉，羊肉，狗肉效果尤佳），除此之后多吃韭菜、核桃、肉桂等蔬果类，可有效改善体质。'
    } else if (BMIDesc == '正常') {
      return '根据您当前的身高体重计算，标准体重为' + referWeight +'kg，体重' + weight + 'kg属于正常范围，当前情况下注意保持饮食规律，健康搭配合理即可，在此标准上若想在增重或减重也应保持在' + (referWeight*0.9).toFixed(1) + 'kg~' + (referWeight*1.1).toFixed(1) + 'kg之间，过度的增减都不益于身体健康，在饮食方面建议合理的荤素搭配，以荤素1:4为宜。'
    } else if (BMIDesc == '超重') {
      return '根据您当前的身高体重计算，体重' + (referWeight*0.9).toFixed(1) + '~' + (referWeight*1.1).toFixed(1) + 'kg为正常范围，当前体重' + weight + 'kg已超出标准线'+ referWeight +'kg，身体状态为超重。科学研究表明超重的人更容易感觉到疲劳，呼吸不畅，偶发性心悸，剧烈运动后更容易引发皮肤疾病。除此之外，行为学家对100名成年男性和女性聚在一起进行测试，最终报告指出，有67名男性更容易对身材较好的异性产生好感，而女性则有84人。最终结论指出，较好的体型更容易在初次见面中获得异性好感。'
    } else {
      return '根据您当前的身高体重计算，体重' + (referWeight*0.9).toFixed(1) + '~' + (referWeight*1.1).toFixed(1) + 'kg为正常范围，当前体重' + weight + 'kg已超出标准线'+ referWeight +'kg，身体状况为肥胖，已超出健康范围。科学研究报告中指出，肥胖者较之常人更容易感到疲劳，体虚气短，呼吸不畅，运动后更容易引发丘疹等皮肤疾病。同时肥胖更是各种疾病的主要诱因，一项科学研究表明，在猝死的人群中，肥胖者高达43%仅此于长期熬夜，猝死主要为突发性心脏疾病，而心脏疾病的高发人群即为肥胖患者，除心脏病外，肥胖同时还容易引发肠胃疾病、皮肤病、宫颈癌症、糖尿病、不孕不育等症状，在此建议肥胖者重视饮食健康，少吃高脂肪食物和油腻食物，科学合理安排饮食，保持乐观积极心态，热爱生活。'
    }
  },
